...
struct GlowEffect: View {
    ...
    var body: some View {
        ZStack {
            EffectNoBlur(gradientStops: gradientStops, width: 8)
                .onAppear {
            ...
            Effect(gradientStops: gradientStops, width: 12, blur: 5)
                .onAppear {
                    // Start a timer to update the gradient stops every second
                    Timer.scheduledTimer(withTimeInterval: 0.4, repeats: true) { _ in
            ...
            Effect(gradientStops: gradientStops, width: 14, blur: 14)
                .onAppear {
                    // Start a timer to update the gradient stops every second
                    Timer.scheduledTimer(withTimeInterval: 0.4, repeats: true) { _ in
            ...
            Effect(gradientStops: gradientStops, width: 18, blur: 18)
                .onAppear {
                    // Start a timer to update the gradient stops every second
